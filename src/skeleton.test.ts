import { sum, wordCount, likes } from "./skeleton";
...
test("Return 'like' text output for given number of names", ()=> {
  ...
  expect(likes(['Alex', 'Jacob', 'Mark', 'Max']).match('Alex, Jacob and 2 others like this'));
})
